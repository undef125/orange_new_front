    ...
    <>
      ...
      <div className="flex flex-col w-[95vw] m-auto my-16">
        {categories.length > 0 ? (
          ...
          <>
            <div className="w-[10rem] h-[2rem] font-semibold mb-8 bg-slate-200"></div>
            <div className="flex flex-wrap overflow-hidden text-black justify-start gap-6  rounded w-[80%]  md:w-[95vw]  ">
              <div className="flex  flex-col-reverse w-[22rem] h-[20rem] bg-slate-200 rounded-md group animate-pulse  "></div>
              <div className="flex  flex-col-reverse w-[22rem] h-[20rem] bg-slate-200 rounded-md group animate-pulse  "></div>
              <div className="flex  flex-col-reverse w-[22rem] h-[20rem] bg-slate-200 rounded-md group animate-pulse  "></div>
              <div className="flex  flex-col-reverse w-[22rem] h-[20rem] bg-slate-200 rounded-md group animate-pulse  "></div>
              <div className="flex  flex-col-reverse w-[22rem] h-[20rem] bg-slate-200 rounded-md group animate-pulse  "></div>
